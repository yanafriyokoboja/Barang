...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent( MainActivity.this, TambahBarangActivity.class));
            }
        });
    ...
    public void refresh() {
//        loading = ProgressDialog.show(ma, null, "harap tunggu...", true, false);
        Call<GetBarang> mahasiswaCall = mApiInterface.getBarang();
        mahasiswaCall.enqueue(new Callback<GetBarang>() {
            @Override
            public void onResponse(Call<GetBarang> call, Response<GetBarang>
                    response) {
                List<Barang> BarangList;
                BarangList = response.body().getListDataBarang();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            startActivity(new Intent( MainActivity.this, JenisActivity.class));

        } else if (id == R.id.nav_slideshow) {
            startActivity(new Intent( MainActivity.this, MerekActivity.class));
